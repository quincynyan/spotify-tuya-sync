...
# Spotify Credentials (supports SPOTIFY_ and SPOTIPY_)
...
print(
	f"DEBUG: Found Client ID: {bool(SPOTIFY_CLIENT_ID)}, Secret: {bool(SPOTIFY_CLIENT_SECRET)}, Refresh Token: {bool(SPOTIFY_REFRESH_TOKEN)}")
